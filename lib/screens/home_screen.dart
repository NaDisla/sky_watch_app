...
class _HomeScreenState extends State<HomeScreen> {
  ...
  bool isHourlyForecast = true, isVisible = false;
  List<WeatherInfo> savedLocs = [];
  Map<int, String> days = {
    1: "Monday",
    2: "Tuesday",
    3: "Wednesday",
        ...
        body: weatherProvider.isLoading || backgroundImageProvider.isLoading
            ...
            : weatherProvider.error.isNotEmpty
                ...
                : backgroundImageProvider.error.isNotEmpty
                    ...
                    : CachedNetworkImage(
                        imageUrl: backgroundImageProvider
                            .backgroundImage.photos![randomImage].src.original,
                        placeholder: (context, url) =>
                            const Center(child: CircularProgressIndicator()),
                        imageBuilder: (context, imageProvider) {
                          weatherProvider.locationsSaved
                                      .where((l) =>
                                          l.location!.name ==
                                          weatherProvider.weatherInfo.location!.name)
                                      .length ==
                                  1
                              ? isVisible = false
                              : isVisible = true;
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            weatherProvider.getForecastInfo(
                                                city: cityController.text);
                                            backgroundImageProvider.getBackgroundImage();
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          width: isVisible ? deviceWidth - 200 : deviceWidth - 20,
                                          child: Center(
                                            child: TextButton(
